...
from mspbots_rmm_mcp.__main__ import _build_http_app
from mspbots_rmm_mcp.config import Settings
from mspbots_rmm_mcp.server import create_mcp_server, get_client_from_context
...
def test_header_present_reaches_request_context():
    ...
    from mspbots_rmm_mcp.server import GatewayTokenMiddleware, _gateway_creds_var
